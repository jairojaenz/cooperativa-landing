...
import { ChevronRight, ChevronUp, Leaf, MapPin, MessageSquare, ShoppingBag, Users, X, Award, Heart } from "lucide-react"
...
// Representación de los detalles del producto
/**
 ...
 * @property {ProductDetails|null} product
 * @property {boolean} open
 * @property {(open: boolean) => void} onOpenChange
 */

export function ProductDetailModal({ product, open, onOpenChange }) {
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{product.availability}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border p-4 bg-muted/20">
            ...
            <div className="grid gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">{product.provider.name}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-medium">Ubicación:</span>
                <span className="text-muted-foreground">{product.provider.location}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-medium">Experiencia:</span>
                <span className="text-muted-foreground">{product.provider.experience}</span>
              </div>
            </div>
          </div>
